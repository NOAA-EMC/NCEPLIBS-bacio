 ...
 * the values corresponding to the operations.
 ...
 * that you want to write data out from or read it in to.
 *
...
/**
 * Do a bacio operation with 64-bit ints. Available operations
 * include:
 *
 * * opening a file.
 * * writing to an open file.
 ...
 */
int
baciol64(int mode, size_t start, size_t size, size_t no,
	 size_t *nactual, int *fdes, const char *fname, void *datary)
{
    /* Initialization. */
    *nactual = 0;
